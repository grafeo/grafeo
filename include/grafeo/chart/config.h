...
typedef enum{
  GRF_LEGEND_LOC_BEST,
  GRF_LEGEND_LOC_UPPER_LEFT,
  GRF_LEGEND_LOC_UPPER_CENTER,
  GRF_LEGEND_LOC_UPPER_RIGHT,
  GRF_LEGEND_LOC_CENTER_LEFT,
  GRF_LEGEND_LOC_CENTER,
  GRF_LEGEND_LOC_CENTER_RIGHT,
  GRF_LEGEND_LOC_LOWER_LEFT,
  GRF_LEGEND_LOC_LOWER_CENTER,
  GRF_LEGEND_LOC_LOWER_RIGHT,
}GrfLegendLocation;
